// Demo seed data — 54 sample curated skills ported from cherryin PR#1.
// 仅在手动执行 `pnpm dlx tsx prisma/seed.ts` 时灌入数据库,生产可不跑。
// 这不是运行时数据:前台 / admin 都从 Postgres 读,跟此文件无关。
